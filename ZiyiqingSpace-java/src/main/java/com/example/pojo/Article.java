...
public class Article implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getAid() == null ? other.getAid() == null : this.getAid().equals(other.getAid()))
            ...
            && (this.getDianzhan() == null ? other.getDianzhan() == null : this.getDianzhan().equals(other.getDianzhan()))
            && (this.getShouchang() == null ? other.getShouchang() == null : this.getShouchang().equals(other.getShouchang()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDianzhan() == null) ? 0 : getDianzhan().hashCode());
        result = prime * result + ((getShouchang() == null) ? 0 : getShouchang().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", dianzhan=").append(dianzhan);
        sb.append(", shouchang=").append(shouchang);
