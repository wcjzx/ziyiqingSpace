<template>
  <div class="articleList">
    <div
      class="spatial-dynamics"
      v-for="(item, index) in spatialdynamics"
      :key="index"
    >
      <div class="tab">
        <i
          class="icon iconfont icon-dongtai"
      ...
      <div class="spatial-dynamics-content">
        ...
        <div
          class="spatial-dynamics-content-item"
          v-for="(item, index) in item.flavors"
          :key="index"
        >
          <div class="img-box"
          @click="toArticle(item.aid)">
          ...
          <div class="text-box">
            ...
            <!--  标题 -->
            <div class="title"
            @click="toArticle(item.aid)">{{ item.articlename }}</div>
            <!-- 发表时间 -->
            <div class="time">
              <i
